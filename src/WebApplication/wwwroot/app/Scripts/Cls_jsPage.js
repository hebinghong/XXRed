...
Cls_jsPage.prototype.setPageFrist = function (sDis, sEn, sNEn) {
    this.PF_D = sDis;
    this.PF_E = sEn;
    this.PF_N = sNEn ? sNEn : sEn;
}
//输入 语言 上页
Cls_jsPage.prototype.setPagePrev = function (sDis, sEn, sNEn) {
    this.PP_D = sDis;
    this.PP_E = sEn;
    this.PP_N = sNEn ? sNEn : sEn;
}
//输入 语言 下页
Cls_jsPage.prototype.setPageNext = function (sDis, sEn, sNEn) {
    this.PN_D = sDis;
    this.PN_E = sEn;
    this.PN_N = sNEn ? sNEn : sEn;
}
//输入 语言 尾页
Cls_jsPage.prototype.setPageLast = function (sDis, sEn, sNEn) {
    this.PL_D = sDis;
    this.PL_E = sEn;
    this.PL_N = sNEn ? sNEn : sEn;
}
//输入 语言 数字跳转
...
Cls_jsPage.prototype.Write = function () {
    document.write(this.CreatHtml());
}
//输出
Cls_jsPage.prototype.CreatHtml = function () {
    var sU = this.getUrl(0), iPI = this.getUrl(1);
    var sN = this.sN, sPI = this.sPI;
    var iPC = this.iPC, iPN = this.iPN; ;
    var iRC = this.iRC, iPS = this.iPS;
    var PF_D = this.PF_D, PF_E = this.PF_E, PF_N = this.PF_N;
    var PP_D = this.PP_D, PP_E = this.PP_E, PP_N = this.PP_N;
    var PN_D = this.PN_D, PN_E = this.PN_E, PN_N = this.PN_N;
    var PL_D = this.PL_D, PL_E = this.PL_E, PL_N = this.PL_N;
